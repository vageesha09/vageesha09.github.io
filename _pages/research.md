...
{% include paper_entry.html
   title="Impact of Cricket on Hindu-Muslim Conflicts in India"
...
{% include paper_entry.html
   title="Demonetization and Domestic Violence"
   %}

{% include paper_entry.html
   title="Women's Land Inheritance and Credit: Evidence from India"
   coauthors="Mansa Saxena"
   %}
